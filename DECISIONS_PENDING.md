...
| D77 | Durée de conservation des présences, messages et notifications. | Volume de données et obligations légales. | Année scolaire en cours plus une année, puis archivage ; **provisoire, à valider avec D76**. **Lot 12 : aucune purge automatique n'est encore en place** (le projet n'a pas de tâche planifiée) : les notifications et leur suivi d'envoi sont conservés tant que rien ne les supprime ; à traiter avant d'annoncer une durée aux parents. |
